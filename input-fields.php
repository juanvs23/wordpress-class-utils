            ...
            <div class="flex flex-col gap-4 pb-3 accordion-container " >
                    ...
                    <?php foreach($value as $item):
                       ...
                       // var_dump($id_base);
                        ...
                        <div class=" w-10/12 accodeon-item-content gap-2 flex flex-col gap-2 ">
                            <h3 style="margin-top:0;margin-bottom:0px">Accordeon item</h3>
                            <input type="text" class="block w-full h-4 px-3 py-2 rounded input-title" id="<?php echo $id_base.'-title'; ?>"  value="<?php echo $title; ?>"  placeholder="Title" >
                            <textarea  id="<?php echo $id_base.'-content'; ?>" class="block w-full h-4 px-3 py-2 rounded input-content"  placeholder="Content"><?php echo $content; ?></textarea>
                        </div>
                ...
                <?php else:
                    ...
                    <div 
                        ...
                        class="accordion-item flex items-center justify-between gap-2 bg-slate-100 p-4">
                        <div class=" w-10/12 accodeon-item-content gap-2 flex flex-col gap-2 ">
                            <h3 style="margin-top:0;margin-bottom:10px">Accordeon item</h3>
                            <input type="text" class="block w-full h-4 px-3 py-2 rounded input-title" id="<?php echo $field_id.'-title'; ?>" name="title"  placeholder="Title" >
                            <textarea  id="<?php echo $field_id.'-content'; ?>" class="block w-full h-4 px-3 py-2 rounded input-content" name="content" placeholder="Content"></textarea>
                        </div>
